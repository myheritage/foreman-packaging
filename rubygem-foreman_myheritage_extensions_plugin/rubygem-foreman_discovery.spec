...
%global gem_name foreman_myheritage_extensions_plugin
...
Summary:    MyHeritage general extensions Plugin for Foreman
Name:       %{?scl_prefix}rubygem-%{gem_name}
Version:    %{mainver}
Release:    %{?prever:0.}%{release}%{?prever}%{?dist}
Group:      Applications/System
License:    GPLv3
URL:        http://github.com/myheritage/foreman_myheritage_extensions_plugin
...
Provides: foreman-plugin-myheritage-extensions
