...
Summary: This library can be used as a module for `fog` or as standalone provider to use the Terremark vCloud in applications.
...
License: MIT
URL: http://github.com/fog/fog-storm_on_demand
Source0: http://rubygems.org/gems/%{gem_name}-%{version}.gem
Requires: %{?scl_prefix}rubygems
Requires: %{?scl_prefix}rubygem(fog-core)
Requires: %{?scl_prefix}rubygem(fog-json) >= 0.1
