...
Summary: This library can be used as a module for `fog` or as standalone provider to use the ServerLove in applications.
...
License: MIT
URL: http://github.com/fog/fog-serverlove
